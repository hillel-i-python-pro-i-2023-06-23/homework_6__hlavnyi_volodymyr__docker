...
def print_info_from_google_sheets():
    print(f'Average hight is {convert_inches_in_cm(get_from_pd_hight(get_google_sheets_pd_data()))}')
    print(f'Average weight is {convert_pounds_in_kg(get_from_pd_weight(get_google_sheets_pd_data()))}')
